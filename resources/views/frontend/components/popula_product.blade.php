<div class="slider-product popular-product tabs-right space-padding-tb-50" data-wow-duration="0.5s" data-wow-delay="400ms">
    <div class="container">
                            ...
                            <div class="slide-product-images">
                                <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt=""/>'>
                                    <a href="#" title="products">
                                        <img class="primary_image" src="{{asset('frontend/images/Dana-home1-product1.jpg')}}" alt="" />
                                    </a>
                                </div>
                                <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt=""/>'>
                                    <a href="#" title="products">
