<div id="secondary" class="widget-area col-xs-12 col-md-3">
    ...
    <aside class="widget widget_color_option">
        ...
        <div class="menu block">
            <form action="#" method="get">
                ...
                <label for="c2"><span class="icon"></span>US-NYC<span class="count">130</span></label>
            </form>
        </div>
    </aside>
    ...
    <aside class="widget widget_size_option">
        <h4 class="active">Compatible OS</h4>
        <div class="menu block">
            <form action="#" method="get">
                <input type="checkbox" id="os1" name="nar" />
                <label for="os1"><span class="icon"></span>Android<span class="count">280</span></label>
                <input type="checkbox" id="os2" name="nar" />
                <label for="os2"><span class="icon"></span>IOS<span class="count">162</span></label>
            </form>
        </div>
    </aside>
    <aside class="widget">
    ...
    <aside class="widget widget_size_option">
        <h4 class="active">Chip type</h4>
        <div class="menu block">
            <form action="#" method="get">
                <input type="checkbox" id="chip1" name="nar" />
                <label for="chip1"><span class="icon"></span>MTK2502<span class="count">112</span></label>
                <input type="checkbox" id="chip2" name="nar" />
                <label for="chip2"><span class="icon"></span>MTK2501<span class="count">130</span></label>
            </form>
        </div>
    </aside>
    <aside class="widget widget_size_option">
