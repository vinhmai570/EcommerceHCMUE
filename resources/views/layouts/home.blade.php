...
<body>
    ...
    <div class="main-content">
        ...
        @include('frontend/components/popula_product')
        @include('frontend/components/banner')
        @include('frontend/components/best_seller_product')
    </div>
    <!-- End MainContent -->
